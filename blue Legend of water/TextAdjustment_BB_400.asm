...
; ################         Defining BB_400.EXE            ####################
.open "EXTRACT\BASE\BB_400.EXE", 0x8003F800
BASE_ADDRESS equ 0x8003F800

;Remove the font clearing call
.org BASE_ADDRESS + 0x3A85C
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0xdebc
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0xf92c
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0xfd64
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0xfe84
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0xdecc
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0xf928
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x201b0
.definelabel CHARS_ON_LINE,	0x800AD628
.definelabel GLYPH_DATA,    0x800C37c0
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x1040c
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0xd66c
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x6be44

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0xff20
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x102bc
