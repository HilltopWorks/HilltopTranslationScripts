...
; ################         Defining BS_MAIN1.EXE            ####################
.open "EXTRACT\BS_MAIN1.EXE", 0x8003F800
...
.org BASE_ADDRESS + 0x5CAA4
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x156c0
	slti 	v0, v0, 0x20
.org 0x80055290
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x17130
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x17568
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x17688
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x156d0
	addiu   v0,v0, 1
.org 0x80055280
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x1712c
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x437b8
.definelabel CHARS_ON_LINE,	0x800BBC70
.definelabel GLYPH_DATA,    0x800BBDB0
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x17c5c
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x14e70
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x7a43c

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x17724
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x17ac0
