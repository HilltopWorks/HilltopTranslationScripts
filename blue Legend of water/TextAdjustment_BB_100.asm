...
; ################         Defining BB_100.EXE            ####################
.open "EXTRACT\BASE\BB_100.EXE", 0x8003F800
BASE_ADDRESS equ 0x8003F800

;Remove the font clearing call
.org BASE_ADDRESS + 0x3CBCC
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x1022C
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x11C9C
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x120d4
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x121f4
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x1023c
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x11c98
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x22520
.definelabel CHARS_ON_LINE,	0x800AF0C0
.definelabel GLYPH_DATA,    0x800C5258
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x1277c
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0xf9dc
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x6d8dc

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x12290
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x1262c
