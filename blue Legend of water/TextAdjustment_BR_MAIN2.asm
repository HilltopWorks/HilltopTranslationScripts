...
; ################         Defining BR_MAIN2.EXE            ####################
.open "EXTRACT\BR_MAIN2.EXE", 0x8003F800
...
.org BASE_ADDRESS + 0x65D84
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x15d40
	slti 	v0, v0, 0x20
.org 0x80055910
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x177b0
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x17be8
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x17d08
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x15d50
	addiu   v0,v0, 1
.org 0x80055900
	addiu   v0,v0, 1	
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x177AC
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x4b068
.definelabel CHARS_ON_LINE,	0x800D8370
.definelabel GLYPH_DATA,    0x800f36f8
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x182dc
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x154f0
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x96ad4

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x17da4
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x18140
