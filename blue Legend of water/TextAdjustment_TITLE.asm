...
; ################         Defining TITLE.EXE            ####################
.open "EXTRACT\MOVIE\TITLE.EXE", 0x8003F800
BASE_ADDRESS equ 0x8003F800

;Remove the font clearing call
.org BASE_ADDRESS + 0x3ABC8
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0xb1c8
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0xCC38
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0xd070
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0xd190
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0xb1d8
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0xcc34
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x1ff5c
.definelabel CHARS_ON_LINE,	0x800A8868
.definelabel GLYPH_DATA,    0x800A8A20
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0xd764
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0xa978
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x670e0

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0xD22C
.definelabel DRAW_TOAST_GLYPH, 0x8004ea18
