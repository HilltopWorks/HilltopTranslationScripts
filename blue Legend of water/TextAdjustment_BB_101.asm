...
; ################         Defining BB_101.EXE            ####################
.open "EXTRACT\BASE\BB_101.EXE", 0x8003F800
BASE_ADDRESS equ 0x8003F800

;Remove the font clearing call
.org BASE_ADDRESS + 0x3D25C
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x108bc
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x1232C
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x12764
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x12884
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x108cc
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x12328
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x22bb0
.definelabel CHARS_ON_LINE,	0x800AFFB8
.definelabel GLYPH_DATA,    0x800C6150
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x12e0c
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x1006c
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x6e7d0

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x12920
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x12cbc
