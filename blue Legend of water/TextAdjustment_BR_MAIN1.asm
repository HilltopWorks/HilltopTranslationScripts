...
; ################         Defining BR_MAIN1.EXE            ####################
.open "EXTRACT\BR_MAIN1.EXE", 0x8003F800
...
.org 0x8009dfc4 ;BASE_ADDRESS + 0x5E7C4
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0xe780
	slti 	v0, v0, 0x20
.org 0x8004e350
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x101f0
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x10628
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x10748
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0xe790
	addiu   v0,v0, 1
.org 0x8004e340
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x101ec
	addiu   v0,v0, 1


.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x43aa8
.definelabel CHARS_ON_LINE,	0x800CF1D8
.definelabel GLYPH_DATA,    0x800EA560
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x10d1c
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0xdf30
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x8d948

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x107e4
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x10b80
