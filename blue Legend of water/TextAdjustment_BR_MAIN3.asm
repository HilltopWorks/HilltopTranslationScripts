...
; ################         Defining BR_MAIN3.EXE            ####################
.open "EXTRACT\BR_MAIN3.EXE", 0x8003F800
...
.org BASE_ADDRESS + 0x61A18
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x119d4
	slti 	v0, v0, 0x20
.org 0x800515a4
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x13444
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x1387c
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x1399c
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x119e4
	addiu   v0,v0, 1
.org 0x80051594
	addiu	v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x13440
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x46cfc
.definelabel CHARS_ON_LINE,	0x800D2B40
.definelabel GLYPH_DATA,    0x800EDEC8
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x13f70
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x11184
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x912ac

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x13a38
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x13dd4
