...
; ################         Defining Br_MAIN4.EXE            ####################
.open "EXTRACT\BR_MAIN4.EXE", 0x8003F800
...
.org BASE_ADDRESS + 0x65360
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x1531C
	slti 	v0, v0, 0x20
.org 0x80054eec
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x16d8c
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x171c4
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x172e4
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x1532c
	addiu   v0,v0, 1
.org 0x80054edc
	addiu   v0,v0, 1	
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x16d88
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x4a644
.definelabel CHARS_ON_LINE,	0x800D6298
.definelabel GLYPH_DATA,    0x800f1620
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x178b8
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x14acc
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x94a08

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x17380
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x1771c
