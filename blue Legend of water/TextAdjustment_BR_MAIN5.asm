...
; ################         Defining BR_MAIN5.EXE            ####################
.open "EXTRACT\BR_MAIN5.EXE", 0x8003F800
...
.org BASE_ADDRESS + 0x5a5ec
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0xa5a8
	slti 	v0, v0, 0x20
.org 0x8004a178
	slti 	v0, v0, 0x20	
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0xc018
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0xc450
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0xc570
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0xa5b8
	addiu   v0,v0, 1
.org 0x8004a168
	addiu 	v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0xc014
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x3f8d0
.definelabel CHARS_ON_LINE,	0x800CA810
.definelabel GLYPH_DATA,    0x800e5b98
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0xcb44
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x9d58
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x88f74

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0xc60c
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0xc9a8
