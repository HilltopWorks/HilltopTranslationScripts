...
; ################         Defining BB_200.EXE            ####################
.open "EXTRACT\BASE\BB_200.EXE", 0x8003F800
BASE_ADDRESS equ 0x8003F800

;Remove the font clearing call
.org BASE_ADDRESS + 0x3A234
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0xd894
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0xf304
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0xf73c
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0xf85c
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0xd8a4
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0xf300
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x1fb88
.definelabel CHARS_ON_LINE,	0x800ACA88
.definelabel GLYPH_DATA,    0x800C2c20
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0xfde4
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0xd044
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x6b2a0

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0xf8f8
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0xfc94
