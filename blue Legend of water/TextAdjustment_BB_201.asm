...
; ################         Defining BB_201.EXE            ####################
.open "EXTRACT\BASE\BB_201.EXE", 0x8003F800
BASE_ADDRESS equ 0x8003F800

;Remove the font clearing call
.org BASE_ADDRESS + 0x39e1c
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0xd47c
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0xeeec
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0xf324
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0xf444
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0xd48c
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0xeee8
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x1f770
.definelabel CHARS_ON_LINE,	0x800AC6B0
.definelabel GLYPH_DATA,    0x800C2848
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0xf9cc
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0xcc2c
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x6aec8

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0xf4e0
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0xf87c
