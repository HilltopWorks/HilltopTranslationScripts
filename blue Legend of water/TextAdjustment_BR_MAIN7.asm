...
; ################         Defining BR_MAIN7.EXE            ####################
.open "EXTRACT\BR_MAIN7.EXE", 0x8003F800
...
.org 0x800a1cbc; BASE_ADDRESS + 0x634bc
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x12478
	slti 	v0, v0, 0x20
.org 0x80052048
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x13ee8
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x14320
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x14440
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x12488
	addiu   v0,v0, 1
.org 0x80052038
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x13ee4
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x477a0
.definelabel CHARS_ON_LINE,	0x800d3330
.definelabel GLYPH_DATA,    0x800EE6D8
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x14a14
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x11c28
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x91a64

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x144dc
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x14878
