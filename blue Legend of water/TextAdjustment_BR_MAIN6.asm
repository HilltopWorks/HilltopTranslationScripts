...
; ################         Defining BR_MAIN6.EXE            ####################
.open "EXTRACT\BR_MAIN6.EXE", 0x8003F800
...
.org BASE_ADDRESS + 0x61A40
	nop
;Increase max glyphs per text line to 32 (Main Dialogue)
.org BASE_ADDRESS + 0x119fc
	slti 	v0, v0, 0x20
.org 0x800515cc
	slti 	v0, v0, 0x20
;Increase max glyphs per text line to 32 (Menu Text)
.org BASE_ADDRESS + 0x1346c
	slti 	v1, v1, 0x20
;Reduce glyph width to 8 when drawing to frame (Main dialogue)
.org BASE_ADDRESS + 0x1C + 0x138a4
	add 	v0, r0, v1
;Reduce glyph width to 8 when drawing to frame (Menu Text)
.org BASE_ADDRESS + 0x1C + 0x139c4
	add 	v0, r0, v1
;Implement 1 byte text (main dialogue)
.org BASE_ADDRESS - 0x20 + 0x11a0c
	addiu   v0,v0, 1
.org 0x800515bc
	addiu   v0,v0, 1
;Implement 1 byte text (menu text)
.org BASE_ADDRESS + 0x13468
	addiu   v0,v0, 1

.definelabel Krom2RawAdd,	BASE_ADDRESS + 0x46d24
.definelabel CHARS_ON_LINE,	0x800D2920
.definelabel GLYPH_DATA,    0x800EDCA8
.definelabel LOAD_IMAGE,    BASE_ADDRESS + 0x13f98
.definelabel DRAW_GLYPH,	BASE_ADDRESS + 0x111ac
.definelabel DRAW_GLYPH_END, DRAW_GLYPH + 0x204 ;0x8004BFCC
.definelabel FONT_START,	BASE_ADDRESS + 0xf0 + 0x9108c

; TOAST text

.definelabel TOAST_1_BYTE,     BASE_ADDRESS + 0x13a60
.definelabel DRAW_TOAST_GLYPH, BASE_ADDRESS + 0x13dfc
